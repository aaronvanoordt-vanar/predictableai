...
1. Aplicar `20260903000001_channels_apollo_oauth_inbox.sql` (`channel_accounts.provider` acepta `apollo`; `inbox_messages.campaign_id/enrollment_id/read_at` + índices; default de `daily_caps` sin LinkedIn).
