...
(function (global) {
  ...
  const PACKAGES = [
    { key: 'starter', credits: 250,  price: '$25.00 USD',  label: 'Starter' },
    { key: 'pro',      credits: 600,  price: '$50.00 USD', label: 'Pro', highlight: true },
    { key: 'scale',    credits: 1500, price: '$120.00 USD', label: 'Scale' },
  ];
  ...
  function ensureChip() {
    ...
    chip.innerHTML = `
      ...
      <span id="credits-chip-buy" style="color:var(--accent-ink, #1A3FD6); font-weight:600">Comprar</span>
    `;
